...
export const Pagination = ({ collection, perPage, onPerPageChange, totalCount, filteredCount, search } : PaginationProps) => {
    return (
        <div className="flex items-center justify-between mt-4">
            ...
            {search ? (
                ...
                <p>Showing <strong>{collection.from}</strong> to <strong>{collection.to}</strong> out of <strong>{collection.total}</strong> entr{totalCount !== 1 ? 'ies' : 'y'} </p>
            )}
